...
import { Cone, DEFAULT_ICE_CREAM_CONE, newScoop, Flavor, Scoop, Topping, IceCreamCone } from "./idl";
...
const findScoopIndex = (iceCream: IceCreamCone, scoopId: string) => iceCream.scoops.findIndex(({id}) => scoopId === id);
