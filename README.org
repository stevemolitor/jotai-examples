...
* Lesson 5 - async
** Branches
- ~async-1-start~ :: selection parts of objects
- ~async-2-load-with-effect~ ::  use Jotai suspense support, but with ~useEffect~
** Links
- [[https://jotai.org/docs/utilities/async][Jotai Async]]
      - async sometimes
      - ~unwrap~
      - ~loadable~
- [[https://github.com/pmndrs/jotai/discussions/2144][Avoid suspending atom after initial fetch]] - my discussion, use ~isPromise~ check to solve
- [[https://github.com/pmndrs/jotai/discussions/2003][Jotai discussion on sync atoms that depend on async atoms]]
** Open Questions
- Best patterns for mixing sync + async atoms.
* Sandboxes
- [[https://codesandbox.io/s/github/stevemolitor/jotai-examples/tree/lesson-1-start][Lesson 1 Start]]
- [[https://codesandbox.io/s/github/stevemolitor/jotai-examples/tree/lesson-1-complete][Lesson 1 Complete]]
